...
### bklog配置
- bklog配置用于配置接入蓝鲸日志平台功能

|            参数             |                             描述                             | 默认值 |
| :-------------------------: | :----------------------------------------------------------: | :----: |
| bklog.file.collectEnabled | 是否采集容器内落地文件日志 | false       |
| bklog.file.dataId | 采集容器内落地文件日志的dataid，dataid在日志平台上申请分配 | 1       |
| bklog.std.collectEnabled | 是否采集容器标准输出日志 | false       |
| bklog.std.dataId | 采集容器标准输出日志的dataid，dataid在日志平台上申请分配 | 1       |

### bkmonitor配置
- bkmonitor配置用于配置接入蓝鲸监控平台功能

|            参数             |                             描述                             | 默认值 |
| :-------------------------: | :----------------------------------------------------------: | :----: |
| bkmonitor.collectEnabled | 是否采集cmdb业务指标数据到蓝鲸监控平台 | false       |
